    ...
    <div className="container py-5">
      <div className="row p-4">
        ...
        <div className="col-md-6 col-sm-12 content-item text-center right-item">
          <h3>VISION</h3>
          <span>
            VISION A futuristic civilization with modern comforts through
      ...
      <div className="row pt-5">
        <div className="col-lg-5 col-md-8 col-sm-12 mx-auto text-center about-me">
          <img src="/56_JPG.webp" />
          <p className="mt-5">
            Founded in 2018, our founder Frederick was developing a sustainable
            solution to challenges in the global food supply chain. Today he
            sets out to help businesses adopt sustainable ESG plans and
            solutions; providing accountability to stakeholders and for a better
